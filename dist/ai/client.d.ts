...
export declare function createSingleClient(provider: ProviderType, model: string, apiKeys: HysaConfig['apiKeys'], ollamaBaseUrl: string, localOpenAiBaseUrl?: string, localOpenAiModel?: string): AIClient;
