...
export declare function buildMinimalSystemPrompt(userName?: string): string;
...
export declare function buildSystemPrompt(projectInfo?: {
    ...
    fileCount: number;
    tree?: string;
}, agentMode?: AgentMode, lightMode?: boolean, provider?: ProviderType, promptMode?: PromptMode, userName?: string): string;
