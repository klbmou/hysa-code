...
export function listSymbols(filePath) {
...
export function findReferences(rootDir, symbol) {
...
export function explainFunction(filePath, functionName) {
    const content = readFile(filePath);
    if (!content)
