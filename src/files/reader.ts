...
export function isGeneratedOutput(filePath: string): boolean {
...
const WELL_KNOWN_SEARCH_ORDER: Record<string, string[]> = {
  'index.html': [
    'web/index.html',
    'index.html',
    'public/index.html',
...
function addUnique(paths: string[], candidate: string): void {
